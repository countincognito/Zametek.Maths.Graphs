...
namespace Zametek.Maths.Graphs
{
        ...
        where TWorkStreamId : struct, IComparable<TWorkStreamId>, IEquatable<TWorkStreamId>
    {
        ...
        /// </summary>
        // Explicit loops rather than Select/DefaultIfEmpty/Min, matching the vertex
        // builder; see the note there. Zero for an empty graph is preserved, as is
        // treating an activity with no value as zero rather than skipping it.
