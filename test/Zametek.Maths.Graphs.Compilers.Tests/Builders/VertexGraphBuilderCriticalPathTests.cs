...
{
    public class VertexGraphBuilderCriticalPathTests
    {
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPathForwardFlow_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            ...
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId4, 11), [activityId2]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId5, 8), [activityId1, activityId2, activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId6, 7), [activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId7, 4), [activityId4]);
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPathBackwardFlow_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenMinimumFreeSlackInStartActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenMinimumFreeSlackInNormalActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
            ...
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId3, 8));
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId4, 11), [activityId2]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId5, 8) { MinimumFreeSlack = 15 }, [activityId1, activityId2, activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId6, 7), [activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId7, 4), [activityId4]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId8, 4), [activityId4, activityId6]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId9, 10), [activityId5]);
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenMinimumFreeSlackInEndActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenMinimumEarliestStartTimeInStartActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenMinimumEarliestStartTimeInNormalActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
            ...
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId3, 8));
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId4, 11), [activityId2]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId5, 8) { MinimumEarliestStartTime = 10 }, [activityId1, activityId2, activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId6, 7), [activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId7, 4), [activityId4]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId8, 4), [activityId4, activityId6]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId9, 10), [activityId5]);
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenMinimumEarliestStartTimeInEndActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenMaximumLatestFinishTimeInStartActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenExtremeMaximumLatestFinishTimeInStartActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenMaximumLatestFinishTimeInNormalActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
            ...
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId2, 7));
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId3, 8));
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId4, 11) { MaximumLatestFinishTime = 18 }, [activityId2]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId5, 8), [activityId1, activityId2, activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId6, 7), [activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId7, 4), [activityId4]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId8, 4), [activityId4, activityId6]);
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenExtremeMaximumLatestFinishTimeInNormalActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
            ...
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId2, 7));
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId3, 8));
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId4, 11) { MaximumLatestFinishTime = 16 }, [activityId2]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId5, 8), [activityId1, activityId2, activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId6, 7), [activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId7, 4), [activityId4]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId8, 4), [activityId4, activityId6]);
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenMaximumLatestFinishTimeInEndActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
            ...
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId6, 7), [activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId7, 4), [activityId4]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId8, 4) { MaximumLatestFinishTime = 22 }, [activityId4, activityId6]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId9, 10), [activityId5]);
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenExtremeMaximumLatestFinishTimeInEndActivity_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
            ...
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId6, 7), [activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId7, 4), [activityId4]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId8, 4) { MaximumLatestFinishTime = 21 }, [activityId4, activityId6]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId9, 10), [activityId5]);
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenMinimumEarliestStartTimeAndMaximumLatestFinishTimeAreInvalid_ThenShouldThrowInvalidOperationException()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
            ...
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId2, 7));
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId3, 8));
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId4, 11) { MinimumEarliestStartTime = 7, MaximumLatestFinishTime = 17 }, [activityId2]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId5, 8), [activityId1, activityId2, activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId6, 7), [activityId3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId7, 4), [activityId4]);
            graphBuilder.AddActivity(new Activity<int, int, int>(activityId8, 4), [activityId4, activityId6]);
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPathForwardFlow_WhenAddingAndRemovingDependencies_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
            ...
            bool result1 = graphBuilder.AddActivityDependencies(activityId6, [activityId5]);
            ...
            bool result2 = graphBuilder.AddActivityDependencies(activityId6, [activityId4]);
            ...
            bool result3 = graphBuilder.RemoveActivityDependencies(activityId6, [5]);
            ...
            bool result4 = graphBuilder.RemoveActivityDependencies(activityId6, [activityId4]);
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPathBackwardFlow_WhenAddingAndRemovingDependencies_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
            ...
            bool result3 = graphBuilder.RemoveActivityDependencies(activityId6, [activityId5]);
            result3.ShouldBeTrue();
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPath_WhenAddingAndRemovingDependencies_ThenAsExpected()
        {
            int eventId = 0;
            int activityId1 = 1;
            int activityId2 = activityId1 + 1;
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateCriticalPathPriorityList_ThenCorrectOrder()
        {
            int eventId = 0;
            var graphBuilder = new VertexGraphBuilder<int, int, int, IActivity<int, int, int>>(new NextIdGenerator<int>(eventId))
            {
            ...
            graphBuilder.AddActivity(new Activity<int, int, int>(4, 11), [2]);
            graphBuilder.AddActivity(new Activity<int, int, int>(5, 8), [1, 2, 3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(6, 7), [3]);
            graphBuilder.AddActivity(new Activity<int, int, int>(7, 4), [4]);
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateResourceSchedulesByPriorityList_WhenOneResource_ThenCorrectOrder()
        {
            int eventId = 0;
            var graphBuilder = new VertexGraphBuilder<int, int, int, IActivity<int, int, int>>(new NextIdGenerator<int>(eventId))
            {
            ...
            List<IResourceSchedule<int, int, int>> resourceSchedules = graphBuilder
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateResourceSchedulesByPriority_WhenListTwoResources_ThenCorrectOrder()
        {
            int eventId = 0;
            var graphBuilder = new VertexGraphBuilder<int, int, int, IActivity<int, int, int>>(new NextIdGenerator<int>(eventId))
            {
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateResourceSchedulesByPriorityList_WhenThreeResources_ThenCorrectOrder()
        {
            int eventId = 0;
            var graphBuilder = new VertexGraphBuilder<int, int, int, IActivity<int, int, int>>(new NextIdGenerator<int>(eventId))
            {
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateResourceSchedulesByPriorityList_WhenFourResources_ThenCorrectOrder()
        {
            int eventId = 0;
            var graphBuilder = new VertexGraphBuilder<int, int, int, IActivity<int, int, int>>(new NextIdGenerator<int>(eventId))
            {
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateResourceSchedulesByPriorityList_WhenFourOrderedResources_ThenCorrectOrder()
        {
            int eventId = 0;
            var graphBuilder = new VertexGraphBuilder<int, int, int, IActivity<int, int, int>>(new NextIdGenerator<int>(eventId))
            {
            ...
            List<IResourceSchedule<int, int, int>> resourceSchedules = graphBuilder
                .CalculateResourceSchedulesByPriorityList(
                [
                    new Resource<int, int>(resourceId1, string.Empty, false, false, InterActivityAllocationType.None, 1.0, 1.0, 4, []),
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateResourceSchedulesByPriorityList_WhenUnlimitedResources_ThenCorrectOrder()
        {
            int eventId = 0;
            var graphBuilder = new VertexGraphBuilder<int, int, int, IActivity<int, int, int>>(new NextIdGenerator<int>(eventId))
            {
        ...
        [Fact]
        public void VertexGraphBuilder_GivenCalculateResourceSchedulesByPriorityList_WhenUnlimitedResourcesWithPotentialOverlap_ThenCorrectOrder()
        {
            int eventId = 0;
            var graphBuilder = new VertexGraphBuilder<int, int, int, IActivity<int, int, int>>(new NextIdGenerator<int>(eventId))
            {
            ...
            graphBuilder.AddActivity(new Activity<int, int, int>(2, 2) { MinimumEarliestStartTime = 1, MaximumLatestFinishTime = 4 }, [1]);
            graphBuilder.AddActivity(new Activity<int, int, int>(3, 2), [1]);
