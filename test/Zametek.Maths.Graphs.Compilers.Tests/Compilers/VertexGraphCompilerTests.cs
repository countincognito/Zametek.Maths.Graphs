...
namespace Zametek.Maths.Graphs.Tests
{
    public class VertexGraphCompilerTests
    {
        ...
        public void VertexGraphCompiler_GivenCompileWithInvalidConstraints_ThenFindsInvalidConstraints()
        {
            ...
            message.AppendLine(Properties.Resources.Message_InvalidConstraints);
            message.AppendLine($@"4 -> {Properties.Resources.Message_MinimumEarliestStartTimePlusDurationMustBeGreaterThanMaximumLatestFinishTime}");
            message.AppendLine($@"9 -> {Properties.Resources.Message_CannotSetMinimumFreeSlackAndMaximumLatestFinishTime}");

            compilationErrors[0].ErrorMessage.ShouldBe(message.ToString());
        }
        ...
        public void VertexGraphCompiler_GivenCompileWithCircularDependencies_ThenFindsCircularDependencies()
        {
            ...
            var message = new StringBuilder();
            message.AppendLine(Properties.Resources.Message_CircularDependencies);
            message.AppendLine(@"4 -> 7 -> 2");
            message.AppendLine(@"9 -> 8 -> 5");
        ...
        public void VertexGraphCompiler_GivenCompileWithInvalidDependencies_ThenFindsInvalidDependencies()
        {
            ...
            var message = new StringBuilder();
            message.AppendLine(Properties.Resources.Message_InvalidDependencies);
            message.AppendLine($@"21 {Properties.Resources.Message_IsInvalidButReferencedBy} 3");
            message.AppendLine($@"22 {Properties.Resources.Message_IsInvalidButReferencedBy} 7");
        ...
        public void VertexGraphCompiler_GivenCompileWithInvalidConstraintsAndCircularAndInvalidDependencies_ThenFindsInvalidConstraintsAndCircularAndInvalidDependencies()
        {
            ...
            var message0 = new StringBuilder();
            message0.AppendLine(Properties.Resources.Message_InvalidDependencies);
            message0.AppendLine($@"21 {Properties.Resources.Message_IsInvalidButReferencedBy} 3");
            message0.AppendLine($@"22 {Properties.Resources.Message_IsInvalidButReferencedBy} 7, 8");

            compilationErrors[0].ErrorMessage.ShouldBe(message0.ToString());

            compilationErrors[1].ErrorCode.ShouldBe(GraphCompilationErrorCode.P0020);

            var message1 = new StringBuilder();
            message1.AppendLine(Properties.Resources.Message_CircularDependencies);
            message1.AppendLine(@"4 -> 7 -> 2");
            message1.AppendLine(@"9 -> 8 -> 5");

            compilationErrors[1].ErrorMessage.ShouldBe(message1.ToString());

            compilationErrors[2].ErrorCode.ShouldBe(GraphCompilationErrorCode.P0030);

            var message2 = new StringBuilder();
            message2.AppendLine(Properties.Resources.Message_InvalidConstraints);
            message2.AppendLine($@"4 -> {Properties.Resources.Message_MinimumEarliestStartTimePlusDurationMustBeGreaterThanMaximumLatestFinishTime}");

            compilationErrors[2].ErrorMessage.ShouldBe(message2.ToString());
        }
        ...
        public void VertexGraphCompiler_GivenCompileWithPostCompilationInvalidConstraints_ThenFindsInvalidConstraints()
        {
            ...
            var message = new StringBuilder();
            message.AppendLine(Properties.Resources.Message_InvalidConstraints);
            message.AppendLine($@"2 -> {Properties.Resources.Message_LatestStartTimeLessThanZero}");
            message.AppendLine($@"2 -> {Properties.Resources.Message_LatestFinishTimeLessThanZero}");
            message.AppendLine($@"2 -> {Properties.Resources.Message_LatestStartTimeLessThanEarliestStartTime}");
            message.AppendLine($@"2 -> {Properties.Resources.Message_LatestFinishTimeLessThanEarliestFinishTime}");
            message.AppendLine($@"4 -> {Properties.Resources.Message_EarliestStartTimeLessThanZero}");
            message.AppendLine($@"4 -> {Properties.Resources.Message_LatestStartTimeLessThanZero}");
        ...
        public void VertexGraphCompiler_GivenCompileWithMinimumFreeSlackPostCompilationInvalidConstraints_ThenFindsInvalidConstraints()
        {
            ...
            var message = new StringBuilder();
            message.AppendLine(Properties.Resources.Message_InvalidConstraints);
            message.AppendLine($@"1 -> {Properties.Resources.Message_FreeSlackLessThanMinimumFreeSlack}");
        ...
        public void VertexGraphCompiler_GivenCompileWithUnavailableResources_ThenFindsUnavailableResources()
        {
            ...
            var message = new StringBuilder();
            message.AppendLine(Properties.Resources.Message_UnavailableResources);
            message.AppendLine($@"{activityId2} -> {resourceId2}");
            message.AppendLine($@"{activityId3} -> {resourceId3}");
            message.AppendLine($@"{activityId4} -> {resourceId2}");
            message.AppendLine($@"{activityId5} -> {resourceId2}, {resourceId3}");
            message.AppendLine($@"{activityId6} -> {resourceId3}");
            message.AppendLine($@"{activityId7} -> {resourceId2}, {resourceId3}");
            message.AppendLine($@"{activityId9} -> {resourceId2}");
            message.AppendLine($@"{activityId10} -> {resourceId3}");
            message.AppendLine($@"{activityId12} -> {resourceId2}, {resourceId3}");
            message.AppendLine($@"{activityId16} -> {resourceId2}, {resourceId3}");
        ...
        public void VertexGraphCompiler_GivenCompileWithCompiledDependenciesAndTwoNoneAndDirectResources_ThenResourceSchedulesCorrectOrder()
        {
            ...
            scheduledActivities0[3].HasNoBilling.ShouldBeFalse();
            ...
            scheduledActivities0[4].HasNoBilling.ShouldBeFalse();
            ...
            scheduledActivities1[1].HasNoBilling.ShouldBeFalse();
            ...
            scheduledActivities1[2].HasNoBilling.ShouldBeFalse();
            ...
            scheduledActivities1[3].HasNoBilling.ShouldBeFalse();
        ...
        public void VertexGraphCompiler_GivenCompileWithCompiledDependenciesAndOneActiveAndTwoInactiveResources_ThenResourceSchedulesCorrectOrder()
        {
            ...
            scheduledActivities0[5].HasNoBilling.ShouldBeFalse();
            ...
            scheduledActivities0[6].HasNoBilling.ShouldBeFalse();
            ...
            scheduledActivities0[7].HasNoBilling.ShouldBeFalse();
            ...
            scheduledActivities0[8].HasNoBilling.ShouldBeFalse();
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithOneOfEachTypeResources_WithNoUncostedUnBilledAndUneffortedActivities_ThenOutputsAsExpected()
        {
            int resourceId1 = 1;
            int resourceId2 = resourceId1 + 1;
            int resourceId3 = resourceId2 + 1;
            ...
            scheduledActivities2[0].HasNoBilling.ShouldBeFalse();
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithOneOfEachTypeResources_WithUnbilledDirectActivity_ThenDirectBillingsRemoved()
        {
            int resourceId1 = 1;
            int resourceId2 = resourceId1 + 1;
            int resourceId3 = resourceId2 + 1;
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithOneOfEachTypeResources_WithUnbilledIndirectActivity_ThenIndirectBillingsUnaffected()
        {
            int resourceId1 = 1;
            int resourceId2 = resourceId1 + 1;
            int resourceId3 = resourceId2 + 1;
            ...
            var activity1 = new DependentActivity<int, int, int>(activityId1, 5);
            activity1.TargetResources.Add(resourceId1);
            var activity2 = new DependentActivity<int, int, int>(activityId2, 3) { HasNoBilling = true };
            activity2.TargetResources.Add(resourceId2);
            var activity3 = new DependentActivity<int, int, int>(activityId3, 12);
            activity3.TargetResources.Add(resourceId3);
            ...
            scheduledActivities1[0].Id.ShouldBe(activityId2);
            scheduledActivities1[0].HasNoCost.ShouldBeFalse();
            scheduledActivities1[0].HasNoBilling.ShouldBeTrue();
            scheduledActivities1[0].HasNoEffort.ShouldBeFalse();
            scheduledActivities1[0].StartTime.ShouldBe(0);
            scheduledActivities1[0].FinishTime.ShouldBe(3);
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithOneOfEachTypeResources_WithUnbilledNoneActivity_ThenNoneBillingsRemoved()
        {
            int resourceId1 = 1;
            int resourceId2 = resourceId1 + 1;
            int resourceId3 = resourceId2 + 1;
            ...
            var activity2 = new DependentActivity<int, int, int>(activityId2, 3);
            activity2.TargetResources.Add(resourceId2);
            var activity3 = new DependentActivity<int, int, int>(activityId3, 12) { HasNoBilling = true };
            activity3.TargetResources.Add(resourceId3);
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithThreeDirectResources_WithUnbilledFirstActivity_ThenFirstBillingsRemoved()
        {
            int resourceId1 = 1;
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithThreeDirectResources_WithUnbilledMiddleActivity_ThenMiddleBillingsRemoved()
        {
            int resourceId1 = 1;
            ...
            scheduledActivities0[1].Id.ShouldBe(activityId2);
            scheduledActivities0[1].HasNoCost.ShouldBeFalse();
            scheduledActivities0[1].HasNoBilling.ShouldBeTrue();
            scheduledActivities0[1].HasNoEffort.ShouldBeFalse();
            scheduledActivities0[1].StartTime.ShouldBe(5);
            scheduledActivities0[1].FinishTime.ShouldBe(8);
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithThreeDirectResources_WithUnbilledLastActivity_ThenLastBillingsRemoved()
        {
            int resourceId1 = 1;
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithThreeIndirectResources_WithUnbilledFirstActivity_ThenNoBillingsRemoved()
        {
            int resourceId1 = 1;
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithThreeIndirectResources_WithUnbilledMiddleActivity_ThenNoBillingsRemoved()
        {
            int resourceId1 = 1;
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithThreeIndirectResources_WithUnbilledLastActivity_ThenNoBillingsRemoved()
        {
            int resourceId1 = 1;
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithThreeNoneResources_WithUnbilledFirstActivity_ThenFirstBillingsRemoved()
        {
            int resourceId1 = 1;
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithThreeNoneResources_WithUnbilledMiddleActivity_ThenMiddleBillingsRemoved()
        {
            int resourceId1 = 1;
        ...
        [Fact]
        public void VertexGraphCompiler_GivenCompileWithThreeNoneResources_WithUnbilledLastActivity_ThenLastBillingsRemoved()
        {
            int resourceId1 = 1;
